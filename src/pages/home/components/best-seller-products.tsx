    ...
    <section>
      <Tabs defaultValue="clothing">
        <div className="mx-auto flex max-w-app flex-col items-center gap-16 py-[3.75rem]">
          <h3 className="text-secondary-foreground border-b-2 border-primary text-2xl font-bold">
            Best Seller Products
          </h3>
          <div className="flex w-full items-center justify-center gap-6">
            <div className="h-1 w-full rounded-full bg-primary" />
            <TabsList
              className="flex h-14 gap-9 rounded-lg border border-border p-1.5"
          ...
          <TabsContent value="clothing">
            <Tabs defaultValue="tops" className="space-y-20 ">
              <div className="flex w-app items-center justify-between gap-4">
                ...
                <button className="border-secondary-foreground flex size-10 items-center justify-center rounded-full border">
                  <ListFilter className="text-secondary-foreground size-6" />
                </button>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative mt-auto flex flex-col gap-3">
                          <h3 className="text-secondary-foreground text-2xl font-medium">
                            Warning
                          </h3>
